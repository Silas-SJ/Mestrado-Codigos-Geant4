...
void mpdTreeManager::FillNtuple(G4double theta, G4double phi, G4double energy, G4double px, G4double py, G4double pz, G4double x, G4double y, G4double z, std::map<G4int,G4int> ScintPionDeca, std::map<G4int,G4int> ScintPionPasso, std::map<G4int,G4int> ScintMuonDeca, std::map<G4int,G4int> ScintMuonPasso, std::map<G4int,G4int> DetabsPionDeca, std::map<G4int,G4int> DetabsPionPasso, std::map<G4int,G4int> GapPionDeca, std::map<G4int,G4int> GapPionPasso, std::vector<G4int> otp, std::vector<G4double> ott)
//void mpdTreeManager::FillNtuple(G4double theta, G4double phi, G4double energy, G4double px, G4double py, G4double pz, G4double x, G4double y, G4double z, std::map<G4int,std::vector<G4double>> ottv)
{
fTheta = theta;
fPhi = phi;
